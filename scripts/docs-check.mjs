...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/manufacturing-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-manufacturing-core:");
...
console.log("Documentation check passed for gutu-plugin-manufacturing-core.");
